...
public class Transaction {
     ...
     * será alterada, e o objeto transaction retornado como resposta através da
     * sua URL de postback ou após o término do processamento da ação atual.
     */
    ...
    /**
     * Texto que irá aparecer na fatura do cliente depois do nome da loja. Max
     * 13 caracteres
     */
    ...
    /**
     * IP de origem que criou a transção, podendo ser ou do seu cliente (quando
     * criado via checkout ou utilizando card_hash) ou do servidor.
     */
    private String ip;
    ...
    public void addSplitRule(SplitRule split) {
        if (isInitializedListSplitRules())
