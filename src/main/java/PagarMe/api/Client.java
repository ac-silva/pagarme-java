...
public class Client implements RestClient {
     ...
     */
    public Client(String baseURI, String apiKey, int... timeout) throws KeyManagementException,
            NoSuchAlgorithmException, KeyStoreException, JsonParseException, JsonMappingException, IOException {
     ...
     * @throws JsonParseException
     */
    public Client(String baseURI, String apiKey, RestTemplate restTemplate, int... timeout)
    ...
    private void setTimeout(int timeout) {
        HttpComponentsClientHttpRequestFactory factory = (HttpComponentsClientHttpRequestFactory) this.restTemplate
                .getRequestFactory();
    ...
    public <T> T create(Object obj, Class<T> class1)
            throws JsonParseException, JsonMappingException, IOException, HttpServerErrorException {
        try {
     ...
     *             the key store exception
     */
    private void createSecurityRestTemplate()
        ...
        HttpClient httpClient = HttpClientBuilder.create().disableCookieManagement().useSystemProperties()
    ...
    @Override
    public <T> T get(List<NameValuePair> vars, Class<T> class1)
            throws JsonParseException, JsonMappingException, IOException, HttpServerErrorException {
